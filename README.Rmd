...
The R code `weatheRcues` was developed to make comparison of weather cues method on biological data, here seed production data. We used here already developed R package (i.e. climwin) but also alternative methods, now accessible in R code from Simmonds et al; Thackeray et al. The current study is already ongoing. 


## Features

The main purpose of `weatheRcues` is to compare different methods to identify weather cues; i.e. what triggers or inhibitors of seed production. Note here that we developped this R compendium, but feel free to adjust the code for other variable you would be interested in, such as tree ring, phenology data, etc.
