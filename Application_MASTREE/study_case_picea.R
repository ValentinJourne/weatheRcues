...
methods.collection.picea = Picea.seed %>%
  dplyr::select(
    sitenewname,
    Country,
    Collection_method,
...
results.moving.site.picea = FULL.moving.climate.analysis(
  seed.data.all = Picea.seed,
...
#combine all the map
Figure.picea = cowplot::plot_grid(
  (Maps.picea / R2picea),
  picea2method,
  labels = 'auto'
)
cowplot::save_plot(
  here::here("figures/Figure.picea.png"),
  Figure.picea,
  ncol = 1.8,
  nrow = 1.5,
  dpi = 300,
